        ...
        <div class="fondo">
            <div class="resultado">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    echo "Su indice de masacorporal es: $resultado <br><br> ";
                ...
                <div>
                    ...
                    if ($resultado < 18.5) {
                        ...
                        echo '<br> <p class="subtitulo">BAJO PESO</p>';

                        echo '<br> <p class= "subpeso"> El bajo peso también presenta riesgos para la salud.
                        ...
                        echo '<br><br> <p class="subtitulo">SALUDABLE</p>';

                        echo '<br> <p class= "subpeso"> La salud se logra manteniendo
                        ...
                        echo '<br><br> <p class="subtitulo">SOBREPESO </p>';

                        echo '<br> <p class= "subpeso"> El sobrepeso puede traer
                        ...
                        echo '<br><br><p class="subtitulo"> OBESIDAD </p>';

                        echo '<br><br> La obesidad es un problema de salud
                        ...
                        echo '<br><br> <p class= "subtitulo"> OBESIDAD SEVERA </p> ';

                        echo '<br><br> La obesidad severa conlleva riesgos graves
